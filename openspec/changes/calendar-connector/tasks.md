...
- [x] **TASK-CAL-01**: Create `src/connectors/calendar.ts` skeleton
...
- [x] **TASK-CAL-02**: Implement `GoogleAuth` helper class (service account path)
...
- [x] **TASK-CAL-03**: Implement `GoogleAuth` OAuth2 token path
...
- [x] **TASK-CAL-04**: Implement `isConfigured()` method
...
- [x] **TASK-CAL-05**: Implement `CalendarAPI` helper (fetch wrapper)
...
- [x] **TASK-CAL-06**: Implement `fullSync()` async generator
...
- [x] **TASK-CAL-07**: Implement `transform()` entity mapping
...
- [x] **TASK-CAL-08**: Add tests for `transform()`
...
- [x] **TASK-CAL-09**: Implement `incrementalSync(cursor?)` async generator
...
- [x] **TASK-CAL-10**: Implement `getCursor()` method
...
- [x] **TASK-CAL-11**: Implement synapse creation for `attended` relationships
...
- [x] **TASK-CAL-12**: Implement synapse creation for `temporal` relationships (recurring events)
...
- [x] **TASK-CAL-13**: Handle cancelled events in upsert flow
...
- [x] **TASK-CAL-14**: Register connector in `src/store.ts`
...
- [x] **TASK-CAL-15**: Add pagination unit tests
...
- [x] **TASK-CAL-16**: Add auth unit tests
...
- [x] **TASK-CAL-17**: Manual integration test
