...
- [ ] **TASK-ENR-01**: Create `src/enrichment/types.ts`
...
- [ ] **TASK-ENR-02**: Implement `EnrichmentEngine` in `src/enrichment/engine.ts`
...
- [ ] **TASK-ENR-03**: Add tests for `EnrichmentEngine`
...
- [ ] **TASK-ENR-04**: Implement `ClassifyProvider` in `src/enrichment/providers/classify.ts`
...
- [ ] **TASK-ENR-05**: Add tests for `ClassifyProvider`
...
- [ ] **TASK-ENR-06**: Create evaluation dataset `src/enrichment/eval/eval-dataset.json`
...
- [ ] **TASK-ENR-07**: Implement evaluation harness `src/enrichment/eval/eval.ts`
...
- [ ] **TASK-ENR-08**: Implement `LLMEnrichProvider` in `src/enrichment/providers/llm-enrich.ts`
...
- [ ] **TASK-ENR-09**: Implement `OpenAIProvider` in `src/enrichment/llm/openai.ts`
...
- [ ] **TASK-ENR-10**: Implement `AnthropicProvider` in `src/enrichment/llm/anthropic.ts`
...
- [ ] **TASK-ENR-11**: Implement `OllamaProvider` in `src/enrichment/llm/ollama.ts`
...
- [ ] **TASK-ENR-12**: Implement `createLLMProvider()` factory in `src/enrichment/llm/index.ts`
...
- [ ] **TASK-ENR-13**: Implement `TopicStitcher` in `src/enrichment/providers/topic-stitch.ts`
...
- [ ] **TASK-ENR-14**: Integrate `EnrichmentEngine` into `src/store.ts`
...
- [ ] **TASK-ENR-15**: Create `src/tools/context-tools.ts`
...
- [ ] **TASK-ENR-16**: Register context tools in `src/tools/index.ts`
  - Import `registerContextTools` from `./context-tools.js`
  - Call `registerContextTools(server, store)` in tool registration function

- [ ] **TASK-ENR-17**: Add `enrich` subcommand to `src/cli.ts`
...
- [ ] **TASK-ENR-18**: Add integration test for LLM provider (mocked)
