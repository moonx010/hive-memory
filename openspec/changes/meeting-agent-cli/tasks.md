...
- [x] **TASK-MTG-01**: Create `src/meeting/transcript-parser.ts`
...
- [x] **TASK-MTG-02**: Add tests for transcript parser
...
- [x] **TASK-MTG-03**: Create `src/meeting/agent.ts` skeleton
...
- [x] **TASK-MTG-04**: Implement meeting entity creation in `MeetingAgent.process()`
...
- [x] **TASK-MTG-05**: Implement speaker entity creation
...
- [x] **TASK-MTG-06**: Implement enrichment call in `process()`
...
- [x] **TASK-MTG-07**: Implement calendar event linking
...
- [x] **TASK-MTG-08**: Implement `renderMarkdown()` in `MeetingAgent`
  ...
  - Format action items as `- [x] {title} — **{owner}** (due: {deadline})`, skip deadline if null
...
- [x] **TASK-MTG-09**: Add tests for `renderMarkdown()`
  ...
  - Test: meeting with action items and owners → correct `- [x]` format
...
- [x] **TASK-MTG-10**: Create `src/tools/meeting-tools.ts`
...
- [x] **TASK-MTG-11**: Register meeting tools in `src/tools/index.ts`
...
- [x] **TASK-MTG-12**: Add `meeting` subcommand to `src/cli.ts`
...
- [x] **TASK-MTG-13**: Add `meeting` to CLI help text in `src/cli.ts`
...
- [x] **TASK-MTG-14**: End-to-end integration test
...
- [x] **TASK-MTG-15**: Create test fixture files
